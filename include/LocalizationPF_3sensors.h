...
public:
	...
	void addFlameParticleLargeVideo2()
	{
		...
		cv::Mat img_lrf_l= createWeightedParImgLarge(all_particles[movie_step], all_lid2_l_likelihood[movie_step], movie_step,false);
		cv::Mat img_lrf_u = cv::Mat(img_lrf_l.rows, img_lrf_l.cols, CV_8UC3, cv::Scalar(255, 255, 255));
		cv::Mat img_omni = createWeightedParImgLarge(all_particles[movie_step], all_omni_likelihood[movie_step], movie_step,false);
		cv::Mat img_gpgga = createWeightedParImgLarge(all_particles[movie_step], all_gpgga_likelihood[movie_step], movie_step,false);
		cv::Mat img_fusion = createWeightedParImgLarge(all_particles[movie_step], all_fusion_likelihood[movie_step], movie_step,true);
